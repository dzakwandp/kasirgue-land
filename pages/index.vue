      ...
      <div class="flex flex-col w-full mt-10">
        <div class="flex w-full mt-10">
          <div class="flex flex-col md:w-1/2">
            <div
              class="flex md:flex-row flex-col justify-end md:items-stretch items-center gap-4 h-max">
              <Card
              ...
              <Card
                class="flex md:w-1/3 w-2/3 flex-col gap-2 items-center shadow-none">
                <div
                  class="flex w-2/3 bg-secondary text-white text-xl p-2 rounded-b-sm justify-center">
                  Premium
                </div>
                <CardContent
                  class="flex flex-col items-center text-center font-number gap-2">
